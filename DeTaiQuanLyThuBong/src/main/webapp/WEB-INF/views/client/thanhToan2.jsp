        ...
        <div class="container">         
                        ...
                        <form class="needs-validation" novalidate>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input value="${customer.firstName }" type="text" class="form-control" id="firstName"  readonly="true">
                                    <div class="invalid-feedback"> Valid first name is required. </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="lastName">Last name *</label>
                                    <input type="text" class="form-control" id="lastName" placeholder="" value="${customer.lastName}"  readonly="true">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" id="username" placeholder="" value="${customer.userName.userName}"  readonly="true">
                                    <div class="invalid-feedback" style="width: 100%;"> Your username is required. </div>
                                </div>
                            </div>
                            <div class="mb-3">
                                <label for="email">Địa chỉ *</label>
                                <input type="email" class="form-control" id="email" placeholder="" value="${customer.address}" readonly="true">
                                <div class="invalid-feedback"> Please enter a valid email address for shipping updates. </div>
                            </div>
                            <div class="mb-3">
                                <label for="address">thành phố *</label>
                                <input type="text" value="${customer.city}" class="form-control" id="address" placeholder="" required readonly="true">
                            ...
                            <div class="shipping-method-box">
                                ...
                                <div class="mb-4">
                                    <div class="custom-control custom-radio">
                                        ...
                                        <label class="custom-control-label" for="shippingOption1">Giao tiêu chuẩn</label> <span class="float-right font-weight-bold">Miễn phí ship</span> </div>
                            		...
                            		<c:forEach var="productX" items="${listPro }">
                            				<tr>
                            					 <td class="thumbnail-img">
                                      				  <a href="#">
                            							<img class="img-fluid" src="data:image/png;base64,${productX.picture}" width="40px;" alt="" />
                            						</a>
                            					</td>
                            					<td class="name-pr">
				                                        <a href="#">
         ...
         maxFractionDigits = "3" value = "${productX.unitPrrice }" />đ
			                                    ...
			                                    <td class="quantity-box">
			                                    	<input type="number" size="4" value="${productX.quatityInStock}" min="0" class="c-input-text qty text" readonly="true">
			                                    </td>
			                                    <td>
			                                    	<a href="${pageContext.request.contextPath}/client/addCart/${productX.productID}" class="c-input-text qty text">thêm |</a>
			                                    	<a href="${pageContext.request.contextPath}/client/lowMyCart/${productX.productID}" class="c-input-text qty text">bớt</a>
			                                    </td>
			                                    <td class="remove-pr">
			                                       	<a href="${pageContext.request.contextPath}/client/deleteMyCart/${productX.productID}">
         ...
         maxFractionDigits = "3" value = "${tong }" />đ </div>
                                </div>
                                <hr class="my-1">
                                ...
                                <div class="d-flex gr-total">
                                    ...
                                    <div class="ml-auto h5">
                                    	<fmt:formatNumber type = "number" 
         maxFractionDigits = "3" value = "${tong }" />đ
                                    </div>
                                </div>
                                <hr> </div>
                        </div>
